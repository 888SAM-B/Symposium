...
const RegisterSymposium = () => {
  ...
  <div className="step-3">
    ...
    {/* Utility function inside Step 3 */}
    {/*
      Returns available members for a given event & slot,
      removing already chosen members from the same session (morning/afternoon).
    */}
    {(() => {
      const getAvailableMembers = (eventName, slot) => {
        ...
        // Collect all members already chosen in this session
        const chosenMembers = [];
        ...
        // Return only members who are not chosen yet
                    ...
                    {[0, 1].map((slot) => (
                      <select
                        ...
                        onChange={(e) => {
                          ...
                          // Clear old member if exists
                          if (events[eventName][slot]) {
                            newEvents[eventName][slot] = "";
                          }
                      ...
                      >
                        ...
                        {getAvailableMembers(eventName, slot).map((m, idx) => (
